...
<table class="cart_table" cellpadding="0" cellspacing="0" border="0">
	...
	foreach($downloads as $download): ?>
		...
		<tr class="cart_item">
			...
			<td><a href="<?php echo site_url('secure/download/' . $download->file_order_token . '/'); ?>"><?php echo $download->file_name; ?></a> (<?php echo ceil((filesize($download->file_path . '/' . $download->file_name)/1024)/1024); ?>MB)</td>
		</tr>
