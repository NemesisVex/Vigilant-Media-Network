...
<div id="gc_tabs">
	...
	<div id="gc_product_attributes">
		...
		<?php
		$data	= array('id'=>'free_shipping', 'name'=>'free_shipping', 'value'=>set_value('free_shipping', true), 'class'=>'gc_tf1', 'checked'=>$free_shipping);
		...
		<?php
		$data	= array('id'=>'shippable', 'name'=>'shippable', 'value'=>set_value('shippable',true), 'class'=>'gc_tf1','checked'=>$shippable);
		echo form_checkbox($data);
		?>
		</div>
		<div class="gc_field">
