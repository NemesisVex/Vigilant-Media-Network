...
<div id="product_right">	
	...
	<div class="tabs">
		...
		<div id="description_tab">
			<?php if (!empty($related_release)): ?>
			<h2>About this album</h2>
			
			<?php echo $related_release->release_music_description; ?>
			
			<h2>Release information</h2>
			
			<ul>
				<li><label>Release date:</label> <?php echo date("m/d/Y", strtotime($related_release->release_release_date)); ?></li>
				<li><label>Label:</label> <?php echo $related_release->release_label; ?></li>
				<li><label>Catalog no.:</label> <?php echo $related_release->release_catalog_num; ?></li>
			</ul>
			
			<?php if (!empty($related_release->tracks)): ?>
			<h2>Tracks</h2>
			
			<ul style="list-style: none;">
			<?php foreach ($related_release->tracks as $track): ?>
				<li><a href="http://eponymous4.com/index.php/music/play/<?php echo $track->track_id; ?>/" type="audio/mpeg" class="htrack" title="<?echo $track->song_title; ?>"><?php echo $track->song_title; ?></a></li>
			<?php endforeach; ?>
			</ul>
