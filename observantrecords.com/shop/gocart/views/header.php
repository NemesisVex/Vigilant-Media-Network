...
<?php if(isset($meta)):?>
	<?php echo $meta;?>
<?php else:?>
<meta name="Keywords" content="Shopping Cart, eCommerce, CodeIgniter, Music, Eponymous 4, CD, MP3">
<meta name="Description" content="Observant Records Web Shop is the exclusive seller of releases by Eponymous 4.">
<?php endif;?>

<link href="<?php echo base_url('css/styles.css');?>" type="text/css" rel="stylesheet"/> 
<link href="<?php echo base_url('css/override.css');?>" type="text/css" rel="stylesheet"/> 
...
<div class="full_wrap">
	<div id="header" class="wide_wrap">
		...
		<a href="<?php echo base_url();?>">
			<img src="<?php echo base_url('images/observant_records_logo.jpg');?>" alt="<?php echo $this->config->item('company_name'); ?>">
		</a>
