...
$config['company_name']		= 'Observant Records';
$config['address1']			= '607 E. Harrison St.';
$config['address2']			= 'Apt. 203';
$config['country']			= 'United States'; // use proper country codes only
$config['city']				= 'Seattle'; 
$config['state']			= 'Washington';
$config['zip']				= '98102';
