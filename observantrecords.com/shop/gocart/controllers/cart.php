...
class Cart extends CI_Controller {
	...
	function product($id)
	{
		...
		if (!empty($data['related_release'])) {
			$data['related_release']->release_music_description = $this->vmview->parse_line_breaks($data['related_release']->release_music_description);
		}
		
		// Observant Records customizations end
