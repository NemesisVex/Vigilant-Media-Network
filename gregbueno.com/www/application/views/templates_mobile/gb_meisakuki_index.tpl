...
{if $rsEntry->entry_allow_comments==1}<a href="/index.php/meisakuki/entry/{$rsEntry->entry_id}/#comments">Comments</a> ({if $rsEntry->comment_count}{$rsEntry->comment_count}{else}0{/if}){/if}
				</p>
			</div>
		</header>
...
{if $rsEntry->entry_text_more}
			<p><strong><a href="/index.php/meisakuki/entry/{$rsEntry->entry_id}/">MORE</a> ...</strong></p>
{/if}
