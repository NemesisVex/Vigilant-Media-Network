<section class="full-column">
	...
	<ul>
		<li><a href="{$config.to_archive}">Archive.Musicwhore.org</a></li>
		<li><a href="{$config.to_filmwhore}">Filmwhore.org</a></li>
		<li><a href="{$config.to_tvwhore}/">TVwhore.org</a></li>
	</ul>
	
	<h3>Archived projects</h3>
	
	<ul>
		<li><a href="{$config.to_austinstories}">Austin Stories</a></li>
		<li><a href="{$config.to_ddn}">Duran Duran Networks</a></li>
	</ul>
</section>