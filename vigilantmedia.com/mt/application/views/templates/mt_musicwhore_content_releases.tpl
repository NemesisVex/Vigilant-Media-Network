...
<tr>
	<td valign="top">
	<strong><a href="/index.php/musicwhore/content/{if $edit==true}remap/{$content_id}{else}map/{$entry_id}{/if}/{$rsRelease->release_id}/{$artist_id}/">{$rsRelease->album_title}</a></strong><br>
	</td>
