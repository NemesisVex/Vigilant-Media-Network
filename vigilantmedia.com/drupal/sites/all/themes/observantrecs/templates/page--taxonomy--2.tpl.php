		<div id="container">
			<div id="masthead">
				...
				<nav id="nav-social">
					<ul>
						<li><a href="http://twitter.com/EmptyEnsemble"><img src="<?php echo observantrecs_get_vigilante_uri(); ?>/images/icons/twitter.png" alt="[Twitter]" title="[Twitter]" /></a></li>
						<li><a href="http://facebook.com/EmptyEnsemble"><img src="<?php echo observantrecs_get_vigilante_uri(); ?>/images/icons/facebook.png" alt="[Facebook]" title="[Facebook]" /></a></li>
