...
(function ()
{
	...
	Ep4.prototype =
	{
		...
		load_album: function (project, version, width, height)
		{
			...
			this.load(this.player_path, width, height, params, flashvars);
		},
...
(function ()
{
	...
	Eponymous4.prototype =
	{
		...
		load_youtube: function (video_id, width, height)
		{
...
(function ()
{
	...
	var Musicwhore = function (selector)
	{
		...
		this.player_path = 'http://vigilante.vigilantmedia.com/swf/mediaplayer.swf';
		this.mp3_path = '/_mp3';
	...
	Musicwhore.prototype =
	{
		...
		load_player: function (file, author, title)
		{
			...
			this.load(this.player_path, 400, 40, params, flashvars);
		},
