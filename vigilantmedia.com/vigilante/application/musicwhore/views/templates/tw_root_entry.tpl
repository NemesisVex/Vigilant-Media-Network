...
{/if}
		...
		<p>
			Share:
			<a href="http://www.facebook.com/sharer.php?u={'http://www.tvwhore.org/index.php/tw/entry/'|cat:$entry_id|cat:'/'|escape:'url'}" title="[Share on Facebook]"><img src="{$config.to_vigilante}/images/icons/facebook.png" alt="[Facebook]" /></a>
			<a href="http://twitter.com/share?url={'http://tvwhore.org/index.php/tw/entry/'|cat:$entry_id|cat:'/'|escape:'url'}&amp;text={'TVwhore.org: '|escape:'url'}{$rsEntry->entry_title|truncate:'75'|escape:'url'}" title="[Share on Twitter]"><img src="{$config.to_vigilante}/images/icons/twitter.png" alt="[Twitter]" /></a>
