					...
					<aside id="frame-1" class="span-6 prepend-1 append-1 prepend-top">
						...
						<p>Greg Bueno started out as a content producer for the newspaper industry in 1997, then retrained to become a web application developer in 1999.</p>

						<p>He specializes in serving as a midpoint between server-side and client-side development. He can create an application back-end in PHP and MySQL, then build the front-end interface with HTML, CSS JavaScript.</p>

						<p>After years of building his own hand-spun code, he moved to using numerous frameworks in 2008. Currently, the majority of his sites are built with CodeIgniter, jQuery and Blueprint CSS.</p>

						<p>He also has experience creating customizations for <a href="http://www.sugarcrm.com/">SugarCRM</a>.</p>

						<p><strong>NOTE:</strong> A number of the samples in this portfolio are internal tools, to which they cannot be linked. Please pardon the inconvenience.</p>
					</aside>

					<section id="frame-2" class="span-14 prepend-top box last">

						<article class="span-6 prepend-1">
							<p><a href="#cases_portal" rel="facebox"><img src="/images/vm_folio_epicom_cases_portal_v02.jpg" width="200" height="128" alt="[Cases Portal for SugarCRM]" title="[Cases Portal for SugarCRM]" border="0"></a></p>
							...
							<div id="cases_portal" style="display:none;">
								...
								<script type="text/javascript">
									$(function () {
										$('a[rel*=facebox_cases_portal]').facebox(facebox_options);
									});
								</script>
								{/literal}
							</div>
						...
						<article class="span-6 prepend-1 last">
							<p><a href="#ni_processdocs" rel="facebox"><img src="/images/vm_folio_ni_processdocs.jpg" width="200" height="128" alt="[NI Tech Comm: Process Documents Portal]" title="[NI Tech Comm Process Documents Portal]" border="0"></a></p>
							...
							<div id="ni_processdocs" style="display:none;">
								...
								<script type="text/javascript">
									$(function () {
										$('a[rel*=facebox_ni_processdocs]').facebox(facebox_options);
									});
								</script>
								{/literal}
							</div>
						...
						<article class="span-6 prepend-1">
							...
							<div id="ni_l10n_manager" style="display:none;">
								...
								<script type="text/javascript">
									$(function () {
										$('a[rel*=facebox_ni_l10n_manager]').facebox(facebox_options);
									});
								</script>
								{/literal}
							</div>
						...
						<article class="span-6 prepend-1 last">
							...
							<div id="ni_icon_glossary" style="display:none;">
								...
								<script type="text/javascript">
									$(function () {
										$('a[rel*=facebox_ni_icon_glossary]').facebox(facebox_options);
									});
								</script>
								{/literal}
							</div>
						...
						<article class="span-6 prepend-1">
							...
							<div id="ni_l10n_image_report" style="display:none;">
								...
								<script type="text/javascript">
									$(function () {
										$('a[rel*=facebox_ni_l10n_image_report]').facebox(facebox_options);
									});
								</script>
								{/literal}
							</div>
						...
						<article class="span-6 prepend-1 last">
							<p><a href="#central_admin" rel="facebox"><img src="/images/vm_folio_central_admin.jpg" width="200" height="128" alt="[Supportkids, Inc.]" title="[Supportkids, Inc.]" border="0"></a></p>

							<p>
								<strong>Vigilant Media Central Administration</strong><br>
								<span class="smaller">
									&raquo; <a href="#central_admin" rel="facebox">More info</a>
								</span>
							</p>
							...
							<div id="central_admin" style="display:none;">
								...
								<script type="text/javascript">
									$(function () {
										$('a[rel*=facebox_central_admin]').facebox(facebox_options);
									});
								</script>
								{/literal}
							</div>
						...
						<article class="span-6 prepend-1">
							...
							<p>
								...
								<span class="smaller">
									...
									&raquo; <a href="http://www.eponymous4.com/">Visit the site</a>
								</span>
							</p>
							...
							<div id="eponymous4" style="display:none;">
								...
								<p>&raquo; <span class="smaller"><a href="http://www.eponymous4.com/">Visit the site</a></span></p>
								
								{literal}
								<script type="text/javascript">
									$(function () {
										$('a[rel*=facebox_eponymous4]').facebox(facebox_options);
									});
								</script>
								{/literal}
							</div>
						...
						<article class="span-6 prepend-1 last">
							...
							<p>
								...
								<span class="smaller">
									...
									&raquo; <a href="http://www.musicwhore.org">Visit the site</a>
								</span>
							</p>
							...
							<div id="musicwhore" style="display:none;">
								...
								<p>&raquo; <span class="smaller"><a href="http://www.musicwhore.org/">Visit the site</a></span></p>
								
								{literal}
								<script type="text/javascript">
									$(function () {
										$('a[rel*=facebox_musicwhore]').facebox(facebox_options);
									});
								</script>
								{/literal}
							</div>
