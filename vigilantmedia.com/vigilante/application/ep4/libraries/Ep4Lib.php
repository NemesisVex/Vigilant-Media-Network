	...
	function __construct()
	{
		...
		switch (ENVIRONMENT)
		{
			case 'development':
				...
				$this->ep4_config['ep4_mp3_root_path'] = OBSERVANTRECORDS_MP3_PATH;
				$this->ep4_config['ep4_zip_root_path'] = OBSERVANTRECORDS_ZIP_PATH;
				$this->ep4_config['ep4_cover_root_path'] = OBSERVANTRECORDS_COVERS_PATH_DEV;
				break;
			case 'testing':
				...
				$this->ep4_config['ep4_mp3_root_path'] = OBSERVANTRECORDS_MP3_PATH;
				$this->ep4_config['ep4_zip_root_path'] = OBSERVANTRECORDS_ZIP_PATH;
				$this->ep4_config['ep4_cover_root_path'] = OBSERVANTRECORDS_COVERS_PATH_TEST;
				break;
			case 'production':
				...
				$this->ep4_config['ep4_mp3_root_path'] = OBSERVANTRECORDS_MP3_PATH;
				$this->ep4_config['ep4_zip_root_path'] = OBSERVANTRECORDS_ZIP_PATH;
				$this->ep4_config['ep4_cover_root_path'] = OBSERVANTRECORDS_COVERS_PATH_PROD;
				break;
		}
