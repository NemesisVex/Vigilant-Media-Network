...
{foreach key=track_id item=rsTrack from=$rsTracks}
	<tr>
		...
		<td  class="play-column" valign="middle" align="center">
			<a href="/index.php/music/play/{$rsTrack->track_id}/" title="{$rsTrack->song_title}" type="audio/mpeg"><img src="{$config.to_vigilante}/images/icons/speaker-grey.gif" /></a>
		</td>
	</tr>
{/foreach}
</table>
...
{if $rsRelease->album_music_description}
{parse_line_breaks txt=$rsRelease->album_music_description}
{/if}
