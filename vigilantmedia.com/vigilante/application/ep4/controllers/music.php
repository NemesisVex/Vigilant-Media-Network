...
class Music extends CI_Controller
{
	...
	function index()
	{
		$this->ep4lib->_format_section_head('Music');
		...
		$this->ep4lib->_smarty_display_ep4_page('ep4_music_index.tpl');
	}
	...
	function cd($album_alias)
	{
		...
		$this->ep4lib->_format_section_head('Music', 'CD', $album_title);
		...
		$this->ep4lib->_smarty_display_ep4_page('ep4_music_cd.tpl');
	}
	...
	function digital($album_alias)
	{
		...
		{
			$this->ep4lib->_format_section_head('Music', 'Digital');
		}
		
		$this->ep4lib->_smarty_display_ep4_page('ep4_music_digital.tpl');
	}
	...
	function track($track_id)
	{
		...
		$this->ep4lib->_format_section_head('Music', 'Digital', $rsTrack->song_title);
		...
		$this->ep4lib->_smarty_display_ep4_page('ep4_music_track.tpl');
	}
	
	function video()
	{
		$this->ep4lib->_format_section_head('Music', 'Video');
		$this->ep4lib->_smarty_display_ep4_page('ep4_music_video.tpl');
	}
