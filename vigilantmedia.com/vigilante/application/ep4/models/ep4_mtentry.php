...
class Ep4_MtEntry extends VmModel_MtEntry {
	...
	private function _limit_by_category($category_id) {
		$this->CI->db->join('mt_placement', 'mt_placement.placement_entry_id=mt_entry.entry_id', 'left outer');
		$this->CI->db->join('mt_category', 'mt_placement.placement_category_id=mt_category.category_id', 'left outer');
