...
class Mw_content_model extends CI_Model
{
	...
	{
		if (false !== ($rowContent = $this->vigilantedblib->_get_record($this->content_map_table, $this->content_map_table_index, $content_id)))
		{
	...
	function get_content_by_album_id($content_album_id)
	{
		if (false !== ($rowContent = $this->vigilantedblib->_get_record($this->content_map_table, 'content_album_id', $content_album_id)))
		{
			$rsContent = $this->vigilantedblib->_db_return_rs($rowContent);
			return $rsContent;
		}
