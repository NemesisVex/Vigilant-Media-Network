...
class Index extends CI_Controller
{
	...
	function index()
	{
		...
		$page_config['base_url'] = '/index.php/sakufu/index/';

		$this->_display_sakufu_page($rowEntries, $offset, $segment, $page_config, 'gb_sakufu_index.tpl');
	}
	...
	function entry($entry_id)
	{
		if ($entry_id == 'random')
		{
			...
			header('Location: /index.php/sakufu/entry/' . $rsEntry->entry_id . '/');
			die();
		}
		...
		$this->gblib->_smarty_display_sakufu_page('gb_sakufu_entry.tpl');
	}
	...
	function date($y)
	{
		...
		$page_config['base_url'] = '/index.php/sakufu/date/' . $y . '/';

		$this->_display_sakufu_page($rowEntries, $offset, 4, $page_config);
	}
	...
	function category($category_id)
	{
		...
		$page_config['base_url'] = '/index.php/sakufu/category/' . $category_id . '/';
	...
	function about()
	{
		...
		$this->gblib->_smarty_display_sakufu_page('gb_sakufu_about.tpl');
	}
	
	function contact()
	{
		$this->gblib->_format_section_head('Contact');
		$this->gblib->_smarty_display_sakufu_page('gb_sakufu_contact.tpl');
	}
	
	function contact_sent()
	{
		$this->gblib->_format_section_head('Contact');
		$this->gblib->_smarty_display_sakufu_page('gb_sakufu_contact_sent.tpl');
	}
	...
	function email()
	{
		...
		'subject' => 't',
		'message' => 'b');
		$this->gblib->email($hidden_fields, $shown_fields, '&#20316;&#35676;', '/index.php/sakufu/contact/sent/');
	}
	
	// Private methods
	function _display_sakufu_page($rowEntries, $offset, $segment, $page_config, $display_page = 'gb_sakufu_index.tpl')
	{
		...
		$this->mysmarty->assign('rsEntries', $rsEntries);
		$this->gblib->_smarty_display_sakufu_page($display_page);
	}
}
