...
class Index extends CI_Controller
{
	...
	function index()
	{
		...
		$page_config['base_url'] = '/index.php/meisakuki/index/';

		$this->_display_meisakuki_page($rowEntries, $offset, $segment, $page_config);
	}
	...
	function entry($entry_id)
	{
		if ($entry_id == 'random')
		{
			...
			header('Location: /index.php/meisakuki/entry/' . $rsEntry->entry_id . '/');
			die();
		}
	...
	function date($y)
	{
		...
		$page_config['base_url'] = '/index.php/meisakuki/date/' . $y . '/';

		$this->_display_meisakuki_page($rowEntries, $offset, 4, $page_config);
	}
	...
	function category($category_id)
	{
		...
		$page_config['base_url'] = '/index.php/meisakuki/category/' . $category_id . '/';
	...
	function about()
	{
		...
		$this->gblib->_smarty_display_meisakuki_page('gb_meisakuki_about.tpl');
	}
	
	function contact()
	{
		$this->gblib->_format_section_head('Contact');
		$this->gblib->_smarty_display_meisakuki_page('gb_meisakuki_contact.tpl');
	}
	
	function contact_sent()
	{
		$this->gblib->_format_section_head('Contact');
		$this->gblib->_smarty_display_meisakuki_page('gb_sakufu_contact_sent.tpl');
	}
	...
	function email()
	{
		...
		'subject' => 't',
		'message' => 'b');
		$this->gblib->email($hidden_fields, $shown_fields, mb_convert_encoding("&#21517;&#20316;&#35352;", 'ISO-8859-1', 'UTF-8'), '/index.php/meisakuki/contact/sent/');
	}
	
	// Private methods
	function _build_entry_page($entry_id, $rsEntry)
	{
		...
		$this->gblib->_smarty_display_meisakuki_page('gb_meisakuki_entry.tpl');
	}

	function _display_meisakuki_page($rowEntries, $offset, $segment, $page_config, $display_page = 'gb_meisakuki_index.tpl')
	{
		...
		$this->mysmarty->assign('rsEntries', $rsEntries);
		$this->gblib->_smarty_display_meisakuki_page($display_page);
	}
}
