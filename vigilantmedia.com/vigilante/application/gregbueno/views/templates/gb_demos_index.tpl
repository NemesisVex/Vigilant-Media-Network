...
{if $rsTrack.release_audio_id}
	<tr>
		...
		<td><a href="{$config.to_eponymous4}/index.php/music/play/{$rsTrack.demo_audio_id}/audio/" type="audio/mpeg" title="{$rsTrack.song_title} (Demo)" class="htrack"></a></td>
		<td><a href="{$config.to_eponymous4}/index.php/music/play/{$rsTrack.release_audio_id}/audio/" type="audio/mpeg" title="{$rsTrack.song_title} (Release)" class="htrack"></a></td>
	</tr>
{/if}
{/foreach}
</table>
